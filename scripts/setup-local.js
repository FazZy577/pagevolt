...
/**
 * Script de configuración inicial para Voltic
...
async function main() {
  console.log('\n🔧 Configuración inicial de Voltic\n');
  ...
  console.log('3. Dale un nombre (ej: "Voltic Deploy")');
  ...
  console.log('2. Selecciona tu sitio Voltic');
  ...
  const envContent = `# Variables de entorno para Voltic
