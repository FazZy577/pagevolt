...
/**
 * Script de configuración inicial para Voltted
...
async function main() {
  console.log('\n🔧 Configuración inicial de Voltted\n');
  ...
  console.log('3. Dale un nombre (ej: "Voltted Deploy")');
  ...
  console.log('2. Selecciona tu sitio Voltted');
  ...
  const envContent = `# Variables de entorno para Voltted
